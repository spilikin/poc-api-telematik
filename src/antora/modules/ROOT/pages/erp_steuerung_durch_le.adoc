...
[source,xml]
----
include::../examples/ti-dienste/task/169/request_taskCreate169.xml[]
----
...
[source,xml]
----
include::../examples/ti-dienste/task/169/response_taskCreate169.xml[]
----
...
[source,xml]
----
include::../examples/ti-dienste/task/169/request_taskActivate169.xml[]
----
...
[source,xml]
----
include::../examples/ti-dienste/task/169/response_taskActivate169.xml[]
----
...
[source,text]
----
include::../examples/kim/emailPlainZuweisungInDerApotheke.txt[]
----
...
[source,text]
----
include::../examples/kim/emailPlainFreieKommunikation.txt[]
----
NOTE: `Subject` enthält den wählbaren Titel der Nachricht. Es dürfen keine personenbezogenen oder medizinischen Informationen enthalten sein. +
...
[source,json]
----
include::../examples/ti-dienste/task/169/response_taskGet169Versicherter.json[]
----
