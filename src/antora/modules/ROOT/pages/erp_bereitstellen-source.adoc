...
NOTE: Der im Verordnetendatensatz angegebene Name des Verordnenden muss dem im Namen im der Qualifizierte elektronischen Signatur QES entsprechen. Eine Prüfung der erlaubten Manipulation des QES-Namens wird Fachdienstseitig vorgenommen und orientiert sich an der Referenzimplementierung zum Namensabgleich. Siehe xref:./resources/referenzimplementierung_namensabgleich.py[]
